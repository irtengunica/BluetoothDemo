...
package com.erhan.android.BluetoothDemo;
...
public class BluetoothDemo extends Activity {
    ...
    private byte[] veri = new byte[1];	//1 byte veri g�nderme de�i�keni
    ...
    private void setupChat() {
       ...
       /* mSendButton = (Button) findViewById(R.id.button_send);
        ...
        //Buton1'e bas�ld���nda LED1 in durumuna g�re LED1 yak�l�r veya s�nd�r�l�r.
		...
		//Buton2'ye bas�ld���nda LED2 in durumuna g�re LED2 yak�l�r veya s�nd�r�l�r.
    ...
    private final Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            /*case MESSAGE_WRITE:
                ...
                //Toast.makeText(getApplicationContext(), "Bilgi g�nderildi",Toast.LENGTH_SHORT).show();
            ...
            case MESSAGE_READ:
                ...
                //Gelen verinin 8. biti 1 ise veri LED ve Buton durum bilgisi olarak de�erlendirilir.
                if((readBuf[0] & 0x80) == 0x80){
				//Gelen verinin 1. bitini durumuna g�re LED1 g�stergesi d�zenlenir.
                ...
                LED1check=false;}
                //Gelen verinin 2. bitinin durumuna g�re LED2 g�stergesi d�zenlenir.
                ...
                LED2check=false;}
                //Gelen verinin 3. bitinin durumuna g�re Buton durum g�stergesi d�zenlenir.
                if((readBuf[0] & 0x04)==0x04)
                	durum.setChecked(true);
                    else
                    durum.setChecked(false);}
				//Gelen verinin 8. biti s�f�r ise gelen veri s�cakl�k bilgisi olarak de�erlendirilir.
                else {
            	if(readBuf[0]>100) readBuf[0]=100;		//S�cakl�k de�eri max 100 dereceyi a�m�cak �ekilde ayarlan�r.
				//S�cakl�k bilgisi g�r�nt�lenir.
				sicaklik.setProgress((int)readBuf[0]);
                isidegeri.setText("S�cakl�k="+readBuf[0]+"�");}			
                break;
